...
const exampleText2 = ["BENKHEDDA WALID"];
const exampleTyping2 = new AutoTyping("#my_name", exampleText2, {
  typeSpeed: 100,
  deleteSpeed: 30,
  waitBeforeDelete: 2000,
  waitBetweenWords: 500,
...
const exampleText3 = ["ANY QUESTIONS ?"];
const exampleTyping3 = new AutoTyping("#quest", exampleText3, {
  typeSpeed: 100,
  deleteSpeed: 30,
  waitBeforeDelete: 2000,
  waitBetweenWords: 500,
